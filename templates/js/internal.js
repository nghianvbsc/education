$(document).on('ready',function(){ 
	...
	$('.bloggs').owlCarousel({
		...
		paginationSpeed : 400,
		singleItem : false,
		navigationText: ['<i class="icofont icofont-bubble-left fa1"></i> Trước', 'Sau <i class="icofont icofont-bubble-right fa2"></i>'],
		pagination: false,
	});
	...
	$(this).parent().find(".hidelink").remove("SHOW ANSWER").text("Thu gọn");
	}).on('hidden.bs.collapse', function(){
	$(this).parent().find(".hidelink").remove("HIDE ANSWER").text("Xem chi tiết");
